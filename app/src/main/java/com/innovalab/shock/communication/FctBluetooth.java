package com.innovalab.shock.communication;
...
public class FctBluetooth extends Thread{
    ...
    public FctBluetooth(Handler hstatus, Handler h) {
        ...
        Log.i("FctBluetooth","Test2, il y a "+pairedDevices.length+ " modules bluetooth pré enregistrés"); // Envoi message debbugage
    ...
    public void sendData(String data, boolean deleteScheduledData) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.i("FctBluetooth","pb envoi infos"); // Envoi message debbugage
        }
    }
